...
import {MakeCellsToggleable} from "./cell_toggle.js";
import {busy_indication_on, busy_indication_off} from "../base.js";
...
export const get_ids_of_selected_items = mouse_event => {
...
$(document).ready(function () {
    ctx = {table_config, filters, popups, current_user_is_at_least_admin, reload_table}
    ...
    let datatable_config = {
        ...
        stateSave: true,
        ajax:
            function (data, cb, settings) {
                socketio.send_to_server("datatable-data", $.extend({}, data, {'filter': JSON.stringify(filter_settings)}));
