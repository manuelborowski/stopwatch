...
def spare_update(incident, data={}):
    return dl.models.update_single(Spare, incident, data)


def spare_get_m(filters=[], fields=[], order_by=None, first=False, count=False, active=True):
